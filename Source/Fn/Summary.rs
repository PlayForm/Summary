/// Asynchronously generates a summary of differences between commits in a git
/// repository.
///
...
/// 4. Generates summaries of differences between the first commit and the last
///    commit, as well as between each pair of consecutive tags.
